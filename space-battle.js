  ...
  const didIWin = () => {
    if (badGuys[0] === "dead") {
      ...
      if (badGuys[3] === "dead") {
        ...
        badGuys[0].fight(youHero); /// al#5 al#6 and al#7 will use more powerful mizzles
        ///    to attack you - better use reddit to fix your hull captian
        ///   they have unlimited shots so I upgraded hull fix to 3 times so can win  .........
      }
    }
  };
  ...
  class Hero {
    ...
    laser(badGuy) {
      if (this.hull >= 1) {
        ...
        console.log("you are dead reset the game refresh the page to play again"); ///// if your hull is less than 1 and you are trying to attack still
      }
    }
  }
